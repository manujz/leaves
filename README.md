...
[![GoDoc](https://godoc.org/github.com/manujz/leaves?status.png)](https://godoc.org/github.com/manujz/leaves)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/manujz/leaves)](https://goreportcard.com/report/github.com/manujz/leaves)
...
```sh
go get github.com/manujz/leaves
```
...
Documentation is hosted on godoc ([link](https://godoc.org/github.com/manujz/leaves)). Documentation contains complex usage examples and full API reference. Some additional information about usage examples can be found in [leaves_test.go](leaves_test.go).
