...
## Higgs dataset for XGBoost model
  ...
  ```sh
    ...
    cp ../data/higgs_1000examples_test.libsvm $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp xghiggs_1000examples_true_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp xghiggs_1000examples_true_raw_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp xghiggs.model $GOPATH/src/github.com/manujz/leaves/testdata/.
  ```
...
## Higgs dataset for LightGBM model
  ...
  ```sh
    ...
    cp ../data/higgs_1000examples_test.libsvm $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp lghiggs_1000examples_true_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp lghiggs.model $GOPATH/src/github.com/manujz/leaves/testdata/.
  ```
...
## MSLTR dateset for LightGBM model
  ...
  ```sh
    ...
    cp ../data/msltr_1000examples_test.libsvm $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp lgmsltr_1000examples_true_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp lgmsltr.model $GOPATH/src/github.com/manujz/leaves/testdata/.
  ```
...
## Agaricus dataset for XGBoost model
  ...
  4.
  ```sh
    cp xgagaricus_true_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp xgagaricus.model $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp ../data/agaricus.txt.test $GOPATH/src/github.com/manujz/leaves/testdata/agaricus_test.libsvm
  ```
...
## Agaricus dataset for XGBoost gblinear model
  ...
  4.
  ```sh
    cp xgblin_agaricus_true_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp xgblin_agaricus_true_raw_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp xgblin_agaricus.model $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp ../data/agaricus.txt.test $GOPATH/src/github.com/manujz/leaves/testdata/agaricus_test.libsvm
  ```
...
## Agaricus dataset for XGBoost DART model
  ...
  4.
  ```sh
    cp xg_dart_agaricus_true_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp xg_dart_agaricus.model $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp ../data/agaricus.txt.test $GOPATH/src/github.com/manujz/leaves/testdata/agaricus_test.libsvm
  ```
...
## Multiclass classification dataset for LightGBM model
  ...
  cp multiclass.test $GOPATH/src/github.com/manujz/leaves/testdata/multiclass_test.tsv
  cp lgmulticlass.model $GOPATH/src/github.com/manujz/leaves/testdata/.
  cp lgmulticlass_true_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
  cp lgmulticlass_true_raw_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
  ```
...
ds.dump_svmlight_file(test_X, test_Y, 'dermatology_test.libsvm')
  ...
  5.
  ```sh
    cp xgdermatology_true_predictions.txt $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp xgdermatology.model $GOPATH/src/github.com/manujz/leaves/testdata/.
    cp dermatology_test.libsvm $GOPATH/src/github.com/manujz/leaves/testdata/.
  ```
